          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="textGray400 ">
                I’m a passionate photographer capturing moments that last
                forever. From intimate portraits to breathtaking landscapes, I
                bring stories to life through my lens.
              </p>
            </div>
